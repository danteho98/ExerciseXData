...
namespace ExerciseXData_ExerciseLibrary.Migrations
{
    ...
    [Migration("20241129235051_RenameCategoriesModelTable")]
    partial class RenameCategoriesModelTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ExerciseXData_ExerciseLibrary.Models.CategoriesModel", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            C_Id = 1,
                            C_Modified_Date = new DateTime(2024, 11, 30, 7, 50, 51, 556, DateTimeKind.Local).AddTicks(6866),
                            C_Name = "Cardio"
                        },
                        new
                        {
                            C_Id = 2,
                            C_Modified_Date = new DateTime(2024, 11, 30, 7, 50, 51, 556, DateTimeKind.Local).AddTicks(6868),
                            C_Name = "Strength"
                        });
                });
            ...
            modelBuilder.Entity("ExerciseXData_ExerciseLibrary.Models.ExercisesModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            E_Id = 1,
                            CategoriesC_Id = 1,
                            E_Modified_Date = new DateTime(2024, 11, 30, 7, 50, 51, 556, DateTimeKind.Local).AddTicks(6985),
                            E_Name = "Running"
                        },
                        new
                        {
                            E_Id = 2,
                            CategoriesC_Id = 2,
                            E_Modified_Date = new DateTime(2024, 11, 30, 7, 50, 51, 556, DateTimeKind.Local).AddTicks(6986),
                            E_Name = "Push-ups"
                        });
                });
