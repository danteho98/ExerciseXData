    ...
    public partial class NewUser : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SQ_Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecurityQuestions", x => x.SQ_Id);
                    table.ForeignKey(
                        name: "FK_SecurityQuestions_AspNetUsers_UsersId",
                        column: x => x.UsersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSecurityQuestions", x => new { x.U_Id, x.SecurityQuestionId });
                    table.ForeignKey(
                        name: "FK_UserSecurityQuestions_AspNetUsers_U_Id",
                        column: x => x.U_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecurityQuestions_UsersId",
